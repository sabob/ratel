 ...
 * under the License.
 */
package com.google.ratel.service.upload;
...
import com.google.ratel.deps.fileupload.FileItemFactory;
import com.google.ratel.deps.fileupload.FileUploadBase;
import com.google.ratel.deps.fileupload.FileUploadException;
import com.google.ratel.deps.fileupload.disk.DiskFileItemFactory;
import com.google.ratel.deps.fileupload.servlet.ServletFileUpload;
import com.google.ratel.deps.fileupload.servlet.ServletRequestContext;
...
public class CommonsFileUploadService implements FileUploadService {
    ...
    public void onInit(ServletContext servletContext) throws Exception {
        ...
        try {
            ...
            if (!RatelUtils.isResourcesDeployable(servletContext)) {
        ...
        if (logWarning) {
            System.out.println("The java.io.tmpdir directory, '" + tmpdir
        ...
        if (restrictedEnvironment) {
            ...
            System.out.println("If you are deploying to Google App Engine,"
