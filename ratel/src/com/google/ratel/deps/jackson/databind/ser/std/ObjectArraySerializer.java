...
import com.google.ratel.deps.jackson.databind.ser.ContainerSerializer;
import com.google.ratel.deps.jackson.databind.ser.ContextualSerializer;
import com.google.ratel.deps.jackson.databind.ser.impl.PropertySerializerMap;
        ...
        if (typeHint != null) {
            ...
            if (javaType.isArrayType()) {
                ...
                if (componentType == Object.class) {
                    o.put("items", com.google.ratel.deps.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode());
                } else {
                    JsonSerializer<Object> ser = provider.findValueSerializer(componentType, _property);
                    JsonNode schemaNode = (ser instanceof SchemaAware) ?
                            ((SchemaAware) ser).getSchema(provider, null) :
                            	com.google.ratel.deps.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
