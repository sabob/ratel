...
import com.google.ratel.deps.jackson.databind.deser.BeanDeserializerModifier;
import com.google.ratel.deps.jackson.databind.deser.DeserializationProblemHandler;
import com.google.ratel.deps.jackson.databind.deser.Deserializers;
import com.google.ratel.deps.jackson.databind.deser.KeyDeserializers;
import com.google.ratel.deps.jackson.databind.deser.ValueInstantiators;
...
import com.google.ratel.deps.jackson.databind.ser.BeanSerializerModifier;
import com.google.ratel.deps.jackson.databind.ser.Serializers;
import com.google.ratel.deps.jackson.databind.type.TypeFactory;
import com.google.ratel.deps.jackson.databind.type.TypeModifier;
    ...
    implements Versioned
{
    ...
    public static interface SetupContext
    {
        ...
        /**
         * Method that module can use to register additional
         * {@link TypeModifier} instance, which can augment {@link com.google.ratel.deps.jackson.databind.JavaType}
         * instances constructed by {@link com.google.ratel.deps.jackson.databind.type.TypeFactory}.
         * 
        ...
        /**
         * Method that module can use to register additional {@link com.google.ratel.deps.jackson.databind.deser.ValueInstantiator}s,
         * by adding {@link ValueInstantiators} object that gets called when 
         * instantatiator is needed by a deserializer.
         * 
         * @param instantiators Object that can provide {@link com.google.ratel.deps.jackson.databind.deser.ValueInstantiator}s for
