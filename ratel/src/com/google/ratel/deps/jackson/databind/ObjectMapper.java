...
import com.google.ratel.deps.jackson.core.io.SegmentedStringWriter;
import com.google.ratel.deps.jackson.core.io.SerializedString;
import com.google.ratel.deps.jackson.core.type.ResolvedType;
import com.google.ratel.deps.jackson.core.type.TypeReference;
import com.google.ratel.deps.jackson.core.util.*;
import com.google.ratel.deps.jackson.databind.cfg.BaseSettings;
import com.google.ratel.deps.jackson.databind.cfg.HandlerInstantiator;
import com.google.ratel.deps.jackson.databind.cfg.MapperConfig;
import com.google.ratel.deps.jackson.databind.deser.*;
...
import com.google.ratel.deps.jackson.databind.jsontype.*;
import com.google.ratel.deps.jackson.databind.jsontype.impl.StdSubtypeResolver;
import com.google.ratel.deps.jackson.databind.jsontype.impl.StdTypeResolverBuilder;
import com.google.ratel.deps.jackson.databind.node.*;
import com.google.ratel.deps.jackson.databind.ser.*;
import com.google.ratel.deps.jackson.databind.type.*;
import com.google.ratel.deps.jackson.databind.util.RootNameLookup;
import com.google.ratel.deps.jackson.databind.util.StdDateFormat;
...
//            TimeZone.getDefault()
    ...
    */
     ...
     * have been annotated with {@link com.google.ratel.deps.jackson.annotation.JsonTypeInfo}).
     * 
     ...
     * {@link com.google.ratel.deps.jackson.annotation.JsonTypeInfo}) will have
     ...
     *  {@link com.google.ratel.deps.jackson.databind.node.ObjectNode}
...
//    	_setupClassLoaderForDeserialization(valueType);
    ...
    public com.google.ratel.deps.jackson.databind.jsonschema.JsonSchema generateJsonSchema(Class<?> t)
