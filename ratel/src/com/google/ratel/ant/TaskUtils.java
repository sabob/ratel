...
class TaskUtils {
    ...
    /**
     * Return all the files in the specified directory and sub-directories. The given filter can be used to accept or reject files.
     *
    ...
    /**
     * Get the contents of an
     * <code>InputStream</code> as a String using the default character encoding of the platform.
     * <p/>
     * This method buffers the input internally, so there is no need to use a
     * <code>BufferedInputStream</code>.
     *
     ...
     * <code>-1</code> after the copy has completed since the correct number of bytes cannot be returned as an int. For large streams use
     * the
    ...
    /**
     * Copy bytes from an
     * <code>InputStream</code> to chars on a
     ...
     * <code>-1</code> after the copy has completed since the correct number of chars cannot be returned as an int. For large streams use
     * the
     ...
     * <p>The new array contains all of the element of
     * <code>array1</code> followed by all of the elements
     * <code>array2</code>. When an array is returned, it is always a new array.</p>
     *
     * <pre>
