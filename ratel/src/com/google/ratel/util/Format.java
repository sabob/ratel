...
import com.google.ratel.deps.lang3.StringEscapeUtils;
...
public class Format implements Serializable {
    ...
    public String escape(Object value) {
        if (value != null) {
            return RatelUtils.escape(value.toString());
        } else {
            return getEmptyString();
        }
    }
    ...
    public String html(Object value) {
        if (value != null) {
            return RatelUtils.escapeHtml(value.toString());
        } else {
            return getEmptyString();
        }
    }
    ...
    public String limitLength(String value, int maxlength, String suffix) {
        return RatelUtils.limitLength(value, maxlength, suffix);
    }
    ...
    public String url(Object object) {
        return RatelUtils.encodeUrl(object, Context.getContext());
    }
}
