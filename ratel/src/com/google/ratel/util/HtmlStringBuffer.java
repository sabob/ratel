...
public class HtmlStringBuffer {
    ...
    public HtmlStringBuffer appendEscaped(Object value) {
        ...
        for (int i = 0, size = string.length(); i < size; i++) {
            if (RatelUtils.requiresEscape(string.charAt(i))) {
                requiresEscape = true;
                break;
            }
        }
        ...
        if (requiresEscape) {
            RatelUtils.appendEscapeString(string, this);
    ...
    HtmlStringBuffer appendHtmlEscaped(Object value) {
        ...
        boolean requiresEscape = false;
        for (int i = 0, size = string.length(); i < size; i++) {
            if (RatelUtils.requiresHtmlEscape(string.charAt(i))) {
                requiresEscape = true;
                break;
            }
        }
        ...
        if (requiresEscape) {
            RatelUtils.appendHtmlEscapeString(string, this);
